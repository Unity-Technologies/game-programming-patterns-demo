...
{
    public class PatternsDemoView : BaseMenuView
    {
        ...
        protected const string k_ButtonDataPath = "ButtonData/DesignPatternsMenu";    // Resources path to ScriptableObject data for buttons
        ...
        public PatternsDemoView(VisualElement rootElement) : base(rootElement)
        {
